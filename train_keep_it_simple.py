...
ckpter = utils_rl.RLModelCheckpoint(simplifier, args.ckpt_every, args.ckpt_lookback, "/hits/basement/nlp/fatimamh/inputs/kis/ckpt/simplifier/%s.bin" % (args.experiment))
...
scorers = [{"name": "coverage", "model": CoverageModel("nostop", model_file="/hits/basement/nlp/fatimamh/inputs/kis/models/coverage_roberta.bin", fp16=True, is_soft=True), "sign": 1, "weight": 2.0},
